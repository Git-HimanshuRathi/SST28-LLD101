...
public class Booking {
    ...
    public Booking(String bookingId, Show show, List<ShowSeat> seats, User user, double totalAmount) {
        this.bookingId = bookingId; this.show = show;
        this.seats = Collections.unmodifiableList(new ArrayList<>(seats));
        this.user = user; this.totalAmount = totalAmount;
    ...
    public void cancel() {
        if (status == BookingStatus.CANCELLED) throw new IllegalStateException("Booking already cancelled");
